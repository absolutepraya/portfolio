...
const experienceData: Experience[] = [
  {
    ...
    desc: '- Designed and pitched **Microsoft-stack AI** solution architectures to enterprise clients (**a leading Indonesian bank** and **a major pulp & paper group**) as the technical partner alongside Business Development, turning business problems into [Azure](https://azure.microsoft.com/) designs, PoC proposals, business cases, and live demos across procurement and HR\n- For the pulp & paper group, architected a [Microsoft Fabric Power BI Copilot](https://www.microsoft.com/en-us/microsoft-fabric) PoC for natural-language procurement analytics (semantic model, hybrid on-prem data-tiering, RLS/CLS) and a **three-agent MRO sourcing system** on [Microsoft Foundry](https://azure.microsoft.com/en-us/products/ai-foundry) automating SAP S/4HANA to Ariba, re-architected from low-code to **pro-code** ([Azure Functions](https://azure.microsoft.com/en-us/products/functions)) after client discovery\n- Built an end-to-end **Azure SRE Agent** demo: a sample FSI loan API (**Node.js/Express**, [Azure SQL](https://azure.microsoft.com/en-us/products/azure-sql), App Insights) with 7 fault-injection types, deployable to both [Azure VM](https://azure.microsoft.com/en-us/products/virtual-machines) and [Azure Container Apps](https://azure.microsoft.com/en-us/products/container-apps), where the agent autonomously remediates safe incidents and proposes human-approved fixes on [Azure Monitor](https://azure.microsoft.com/en-us/products/monitor) alerts',
    alignCenter: false,
  },
  {
