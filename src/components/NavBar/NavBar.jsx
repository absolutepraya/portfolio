...
const NavBar = ({ desktopView }) => {
	...
	return (
		<div className='fixed top-8 z-20 flex h-[4.9rem] w-auto flex-row items-center justify-between rounded-3xl border border-[#262626] bg-[#262626] bg-opacity-40 px-2.5 backdrop-blur-md md:w-[55rem] md:scale-100 scale-[97%]'>
