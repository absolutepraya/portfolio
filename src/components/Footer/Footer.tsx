  ...
  return (
    <footer className='flex w-full flex-col'>
      ...
      >
        ...
        <div className='flex h-auto w-full flex-col items-center space-y-2 border-customgray border-t pt-1 pb-1 md:h-16 md:flex-row md:justify-around md:space-y-0 md:py-0'>
