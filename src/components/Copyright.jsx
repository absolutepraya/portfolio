...
const Copyright = () => {
  ...
  return (
    <div className='flex w-full flex-col'>
      <div className='flex w-full flex-col items-center justify-between space-y-2 border-t border-customgray bg-customgray bg-opacity-40 py-4 font-jetbrainsmono text-xs md:h-16 md:flex-row md:space-y-0 md:px-8 md:py-0 md:text-xs lg:px-32'>
